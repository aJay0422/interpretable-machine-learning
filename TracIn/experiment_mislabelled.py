...
if __name__ == "__main__":
    ...
    correct_loader = DataLoader(mydataset(X_correct, Y_correct), batch_size=40, shuffle=True)
    wrong_loader = DataLoader(mydataset(X_wrong, Y_wrong), batch_size=40, shuffle=True)
